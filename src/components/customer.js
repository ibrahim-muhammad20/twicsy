              ...
              >
                ...
                >
                  <div className="testimonial-with-video testimonial-with-video--yellow">
                    <p>
                      “{/* */}I use Twicsy every single day and I love it. It's
                      a great tool for my Instagram account.{/* */}”
                    </p>
                ...
                >
                  <div className="testimonial-with-video testimonial-with-video--cyan">
                    <p>
                      “{/* */}I've been using Twicsy for a few months now and
                      it's really great. Best decision I've ever made.{/* */}”
                    </p>
                    <div className="testimonial__video">
                      <svg
                        className="svg-icon svg-icon--testimonialCheck"
                      ...
                      <div className="video-holder is-animated">
                        <video
                          src="/videos/get-followers-video-2.mp4"
                          autoPlay=""
                          muted=""
                          loop=""
                          playsInline=""
                ...
                <div className="slider__slide embla__slide is-prev-slide">
                  <div className="testimonial-with-video testimonial-with-video--purple">
                    <p>
                      “{/* */}Not only is it easy to use, but it's also very
                      powerful. I've been consistently hitting the explore page
                ...
                <div className="slider__slide embla__slide is-current-slide">
                  <div className="testimonial-with-video testimonial-with-video--yellow">
                    <p>
                      “{/* */}Our company has been skyrocketed by using Twicsy.
                      I wish we knew about it sooner.{/* */}”
                    </p>
                    <div className="testimonial__video">
                      <svg
                        className="svg-icon svg-icon--testimonialCheck"
                ...
                <div className="slider__slide embla__slide is-next-slide">
                  <div className="testimonial-with-video testimonial-with-video--cyan">
                    <p>
                      “{/* */}Sometimes things might be too good to be true. But
                      with Twicsy, that's not the case.{/* */}”
                    </p>
                    <div className="testimonial__video">
                      <svg
                        className="svg-icon svg-icon--testimonialCheck"
                ...
                >
                  <div className="testimonial-with-video testimonial-with-video--purple">
                    <p>
                      “{/* */}Really love the simplicity of the interface and
            ...
            <div className="flex-row lg-justify-between md-justify-between sm-justify-between">
              <div className="rating">
                ...
                <div className="rating__content">
                  ...
                  <p className="text-sm">
                    <strong className="text-orange">5{/* */} / 5</strong> —
                    based on {/* */}6{/* */} reviews
                  </p>
                </div>
              </div>
              <button onClick={btnForm} className="btn btn--secondary hidden-xs"  >
                <span />
                <span />
                <span />
          ...
          <div className="section__inner">
            <div className="shell">
              <div className="section__footer text-sm">
                <button type="button"
           onClick={btnForm} className="btn btn--secondary visible-xs">
                  <span />
                  <span />
                  <span />
                  <strong>Submit Your Review</strong>
                ...
                >
                  <div className="slider__slide embla__slide is-current-slide">
                    <div className="testimonial text-sm">
                      ...
                      <blockquote>
                        {" "}
                        {/* */}I love Instagram, great platform to share photos,
                        videos, etc., can't live a day without it 🙂 I guess I'm
                        not the only one crazy about this social network. It
                        wasn't easy to attract followers, so I decided to try
                        this service. Thank you very much, twicsy.com, for the
                        stunning result, number of my subscribers has increased
                        significantly.{/* */}{" "}
                      </blockquote>
                      <cite>— {/* */}Matt V</cite>
                    </div>
                  ...
                  <div className="slider__slide embla__slide is-current-slide">
                    <div className="testimonial text-sm">
                      ...
                      <blockquote>
                        {" "}
                        {/* */}This service is the best when you want to make
                        your Instagram account more popular! The price is nice.
                        You get followers and likes almost instantly. If
                        something is wrong, the support will explain everything.
                        They will fix it so you won't lose your money. I managed
                        to increase the number of subscribers from 5000 to 11000
                        in a day! A great result. And no need to waste time
                        doing it yourself 🙂{/* */}{" "}
                      </blockquote>
                      <cite>— {/* */}F S</cite>
                    </div>
                  ...
                  <div className="slider__slide embla__slide is-current-slide">
                    <div className="testimonial text-sm">
                      ...
                      <blockquote>
                        {" "}
                        {/* */}I used to think that on Instagram you could only
                        gain subscribers with quality content that was
                        frequently updated. But now, with the good help of this
                        site, I am constantly building up my followers. I can
                        also increase my views and likes here. And this is very
                        important for my account because with its help I conduct
                  ...
                  <div className="slider__slide embla__slide is-current-slide">
                    <div className="testimonial text-sm">
                      ...
                      <blockquote>
                        {" "}
                        {/* */}better than all other websites and this one
                        actually works!{/* */}{" "}
                      </blockquote>
                      <cite>— {/* */}andre</cite>
                    </div>
                  ...
                  <div className="slider__slide embla__slide is-next-slide">
                    <div className="testimonial text-sm">
                      ...
                      <blockquote>
                        {" "}
                        {/* */}Great service and like that you're given a trial
                        before paying!{/* */}{" "}
                      </blockquote>
                      <cite>— {/* */}Kay</cite>
                    </div>
