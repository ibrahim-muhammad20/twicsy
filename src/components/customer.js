...
function Customer() {
  // const [isActive, setIsActive] = useState("slider__button embla__button");
  // const [style,setStyle]=useState(false);
  // const toggleSwitch=(event)=>{
  //  event.currentTarget.classList.toggle('slider__button--prev embla__button embla__prev')
  //   style? setStyle(false):setStyle(true);
  //   console.log(style);
  // }
  // const toggleSwitch2=(event)=>{
  //  event.currentTarget.classList.toggle('slider__button--prev embla__button embla__next')
  //   style? setStyle(false):setStyle(true);
  //   console.log(style);
  // }
 
  const myStyle1={
    transform:"translate3d(25.2912%, 0px, 0px)"  
  }
  const myStyle2={
    left: "0%" 
  }
      ...
      <div className="section section--gray section--testimonials">
        <div className="shell">
          <div className="section__head">
            ...
            <h2 className='scolor1'>Here’s what our customers say</h2>
          </div>
        </div>
        <div className="embla embla--alt slider-testimonial-with-video">
          <div className="slider__container embla__container is-draggable">
            <div className="slider__slides embla__slides st4" >
              <div className="slider__slide embla__slide is-current-slide st2 ">
                <div className="testimonial-with-video testimonial-with-video--yellow">
                  <p>“
                    I use Twicsy every single day and I love it. It's a great tool for my Instagram account.
                    ”
                  </p>
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    ...
                    <div className="video-holder is-animated"><video src="/videos/get-followers-video-1.mp4" autoplay=""
                      muted="" loop="" playsinline=""></video></div>
                  </div><i className="svg-blob svg-blob--BlobSmiling testimonial__blob"><svg width="227" height="252"
              ...
              <div className="slider__slide embla__slide is-next-slide st2">
                <div className="testimonial-with-video testimonial-with-video--cyan">
                  <p>“
                    I've been using Twicsy for a few months now and it's really great. Best decision I've ever
                    made.
                    ”
                  </p>
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    ...
                    <div className="video-holder is-animated"><video src="/videos/get-followers-video-2.mp4" autoplay=""
                      muted="" loop="" playsinline=""></video></div>
                  </div><i className="svg-blob svg-blob--BlobSmiling testimonial__blob"><svg width="227" height="252"
                    viewBox="0 0 227 252" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                    ...
                    <path opacity="0.6"
                      d="M60.0242 30.1465C63.523 38.5012 73.1092 37.5705 76.1684 31.084M84.3365 31.084C87.8353 39.4387 97.4214 38.508 100.481 32.0214M43.8801 36.6044C60.0242 57.124 104.517 57.2282 117.49 37.6461"
                      stroke="#0C7C84" stroke-width="3.90705" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg></i>
                </div>
              </div>
              <div className="slider__slide embla__slide">
                <div className="testimonial-with-video testimonial-with-video--purple">
                  <p>“
                    Not only is it easy to use, but it's also very powerful. I've been consistently hitting the
                    explore page for the past few weeks.
                    ”
                  </p>
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="video-holder"><video src="" autoplay="" muted="" loop="" playsinline=""></video></div>
                  </div><i className="svg-blob svg-blob--BlobSmilingAlt testimonial__blob"><svg width="280" height="370"
                    viewBox="0 0 280 370" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.4">
                      <path
                        ...
                        fill="url(#paint0_linear_497_3813)"></path>
                      <path
                        d="M109.817 268.433C90.2663 252.138 79.0139 247.924 79.0793 223.422L79.4623 107.622C79.5799 63.61 115.905 30.1325 160.597 32.848C205.289 35.5635 241.424 73.4438 241.306 117.456L241.195 131.467L242.279 275.722L178.906 263.551C154.736 267.963 129.368 284.728 109.817 268.433Z"
                        fill="#D5B5FF"></path>
                    </g>
                    <path
                      ...
                      stroke="#6635A6" stroke-width="4.39369" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M144.349 81.4268C150.442 95.4399 167.136 93.8789 172.463 82.9992" stroke="#6635A6"
                      stroke-width="4.39369" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg></i>
                </div>
              </div>
              <div className="slider__slide embla__slide">
                <div className="testimonial-with-video testimonial-with-video--yellow">
                  <p>“
                    Our company has been skyrocketed by using Twicsy. I wish we knew about it sooner.
                    ”
                  </p>
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="slider__slide embla__slide">
                <div className="testimonial-with-video testimonial-with-video--cyan">
                  <p>“
                    Sometimes things might be too good to be true. But with Twicsy, that's not the case.
                    ”
                  </p>
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="slider__slide embla__slide st5" >
                <div className="testimonial-with-video testimonial-with-video--purple">
                  <p>“
                  ...
                  <div className="testimonial__video"><svg className="svg-icon svg-icon--testimonialCheck" width="35"
                    ...
                    <div className="video-holder is-animated"><video src="/videos/get-followers-video-3.mp4" autoplay=""
                      muted="" loop="" playsinline=""></video></div>
                  </div><i className="svg-blob svg-blob--BlobSmilingAlt testimonial__blob"><svg width="280" height="370"
                    viewBox="0 0 280 370" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.4">
          ...
          <div className="slider__cta embla__cta">
            <button type="button" className="slider__button slider__button--next embla__button, embla__prev" >
            </button>
            <button type="button" className="slider__button slider__button--next embla__button  embla__next" >
              </button>
          </div>
          <div className="slider__dots embla__dots">
            <button type="button"  className="embla__dot is-active">
              </button>
              <button type="button"  className="embla__dot">
                </button>
                <button type="button"  className="embla__dot">
                  </button>
                  <button type="button"  className="embla__dot">
        ...
        <div className="shell">
          <div className="flex-row lg-justify-between md-justify-between sm-justify-between">
            <div className="rating">
              <div className="rating__circle"><span className="text-orange">5</span> <i>of 5</i>
              </div>
              <div className="rating__content">
                <h6>Customers rate us<strong className="text-orange">Superb</strong>
                  <div className="stars text-xsm">
                    <ul>
                      <li><svg className="svg-icon svg-icon--star" width="19" height="20" viewBox="0 0 19 20" fill="none"
                ...
                <p className="text-sm"><strong className="text-orange">5/ 5
                </strong> — based on  6 reviews
                </p>
              </div>
            </div><button className="btn btn--secondary hidden-xs"><span></span><span></span><span></span><strong>Submit
              Your Review</strong></button>
          </div>
        </div>
        <div className="section__inner">
          <div className="shell">
            <div className="section__footer text-sm"><button
              className="btn btn--secondary visible-xs"><span></span><span></span><span></span><strong>Submit Your
                Review</strong></button></div>
          </div>
          <div className="embla slider-testimonials">
            <div className="slider__container embla__container is-draggable">
              <div className="slider__slides embla__slides st6">
                <div className="slider__slide embla__slide st2">
                  <div className="testimonial text-sm">
                    <div className="testimonial__quotes"><svg className="svg-icon svg-icon--quotes" width="21" height="15"
                      viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <blockquote>
                      I love Instagram, great platform to share photos, videos, etc., can't live a day without
                      it 🙂 I guess I'm not the only one crazy about this social network. It wasn't easy to attract
                      followers, so I decided to try this service. Thank you very much, twicsy.com, for the stunning
                ...
                <div className="slider__slide embla__slide st2">
                  <div className="testimonial text-sm">
                    ...
                    <blockquote>
                      This service is the best when you want to make your Instagram account more popular!
                      The price is nice. You get followers and likes almost instantly. If something is wrong, the
                      support will explain everything. They will fix it so you won't lose your money.
                      I managed to increase the number of subscribers from 5000 to 11000 in a day! A great result. And
                      no need to waste time doing it yourself 🙂
                ...
                <div className="slider__slide embla__slide is-prev-slide st2">
                  <div className="testimonial text-sm">
                    <div className="testimonial__quotes"><svg className="svg-icon svg-icon--quotes" width="21" height="15"
                      viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <blockquote>
                      I used to think that on Instagram you could only gain subscribers with quality content
                      that was frequently updated. But now, with the good help of this site, I am constantly building up
                      my followers. I can also increase my views and likes here. And this is very important for my
                      account because with its help I conduct an educational project that helps many people.
            ...
            <div className="slider__cta embla__cta">
              <button className="slider__button slider__button--prev embla__button embla__prev">
                ...
                className="slider__button slider__button--next embla__button embla__next">
                  </button></div>
          </div>
        </div>
      </div>
