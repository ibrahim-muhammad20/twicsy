      ...
      <div className="hero__inner">
        ...
        <div className="hero__content">
          <div className="hero__text">
            <h1>
              Buy Instagram Views <br className="hidden-xs" /> with{" "}
            ...
            <p>
              Twicsy allows you to safely boost the views on your
                    ...
                    <div className="plan is-active">
                      <div className="plan__inner">
                        ...
                        <div className="plan__price text-sm">
                          <span>$2.21</span>{" "}
                          <strong className="text-orange">$1.99</strong>
                        </div>
                        <a
                  ...
                  <div className="slider__slide embla__slide is-selected">
                    <div className="plan">
                      <div className="plan__inner">
                        ...
                        <div className="plan__price text-sm">
                          <span>$23.42</span>{" "}
                          <strong className="text-orange">$14.99</strong>
                        </div>
                        <a
                          className="plan__link"
                  ...
                  <div className="slider__slide embla__slide is-selected">
                    <div className="plan">
                      <div className="plan__inner">
                        ...
                        <div className="plan__price text-sm">
                          <span>$49.00</span>{" "}
                          <strong className="text-orange">$24.99</strong>
                        </div>
                        <a
                          className="plan__link"
                  ...
                  <div className="slider__slide embla__slide">
                    <div className="plan">
                      <div className="plan__inner">
                        ...
                        <div className="plan__price text-sm">
                          <span>$299.96</span>
                          <strong className="text-orange">$74.99</strong>
                        </div>
                        <a
                          className="plan__link"
