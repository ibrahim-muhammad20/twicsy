...
export default function Move7() {
  ...
  >
    ...
    <div className="slider__slide embla__slide" style={{ left: "160%" }}>
      <div className="plan">
        <div className="plan__inner">
          <div className="plan__bar">
            <span style={{ width: "60%" }} />
    ...
    <div className="slider__slide embla__slide is-prev-slide">
      <div className="plan">
        <div className="plan__inner">
          <div className="plan__bar">
            <span style={{ width: "71%" }} />
