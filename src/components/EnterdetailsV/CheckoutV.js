...
import StripeContainer2 from '../Stripe/StripContainer2';
...
export default function CheckoutV(props) {
  var textstyle = {
    padding:"18px",
    color: "#0A7E7E"
  };
  ...
  <div className="checkflex ftop">
      ...
      <div className="box order-review open">
        ...
        <div className="body">
          <div className="r-mobi">
            ...
            <div className="price">
              <span className="total-cost-mini">${props.prizev}</span>
            </div>
            <div className="arrow">
          ...
          <div className="r-body">
            ...
            <div className="r-plan">
              <div className="r-item">
                ...
                <div className="info">
                  ...
                  <div className="extra">
                    <strong>{props.views}</strong> views / <strong>1</strong> posts
                  </div>
                </div>
                <div className="price">${props.prizev}</div>
              </div>
              <div className="r-item upsell">
                ...
                <div className="info">
                  <span>
                    <strong>50</strong> views per post
                  </span>{" "}
            ...
            <div className="r-upsell" data-id={1} data-cost="1.11">
              <div className="line">
                ...
                <div className="text">
                  Add <strong>50</strong> Views per post and{" "}
            ...
            <div className="r-total">
              ...
              <strong className="total-cost price">{"="} ${props.prizev}</strong>
            </div>
            ...
            <div className="r-feature">
              <div className="item ">
                ...
                <div className="text">
                  <strong>Real Views</strong> from real people
                </div>
              </div>
              <div className="item">
                <div className="icon">
                ...
                <div className="text">
                  <strong>Split Views</strong> on multiple posts
                </div>
              </div>
              <div className="item">
                <div className="icon">
      ...
      <div className="box ccheckout">
        ...
        <div className="body">
          ...
          <button onClick={(e)=>{e.preventDefault()
            ...
            Pay ${props.prizev} USD Using Paypal
            {/* <span className="">
              Pay 
            </span> */}
          </button>
    ...
    />}
          <button onClick={(e)=>{e.preventDefault()
            ...
            Pay ${props.prizev} USD Using Stripe
            {/* <span className="">
              Pay 
            </span> */}
          </button>
          {stripe2 && <StripeContainer2 prizev={props.prizev}/> }
          ...
          <div className="box">
            <div id="OfferPrompt" className="body">
              ...
              <div className="subtitle">
                ...
                <br /> <b className="highlight">30% off Views</b> if added
                now.
              </div>
              <div className="items">
                <div className="items-inner">
                  <div className="item">
                    ...
                    <div className="desc">{props.views}</div>
                    <div className="price">
