...
export default function Boost2() {
  ...
  return (
    ...
    >
      <div className="section section--homepage-boxes">
        <div className="shell">
          <div className="boxes">
            <ul>
              <li>
                <div onClick={btnActive2} className={act?"box is-expanded":"box "}>
                  <div className="box__inner">
                    <div className="box__head">
                      <strong>Get a Bigger Social Presence</strong>
                    </div>
                    <div className="box__entry">
                      <p>
                        More Instagram followers, likes, and views boost your
                        presence on social media platforms. A popular Instagram
                        page makes your Instagram account credible, increases
                        brand awareness in your target audience, attracts
                        potential customers and Instagram influencers – and
                        grows your online presence and engagement rate!
                      </p>
                    </div>
                    <div className="svg-image svg-image--boxBlobs box__image">
                      <svg
                        width="139"
                        height="150"
                        viewBox="0 0 139 150"
                    ...
                    <button type="button" onClick={btnSign1} className={style1?"btn-more box__btn is-active " :"btn-more box__btn "}>
              ...
              <li>
                <div onClick={btnActive3} className={act2?"box is-expanded":"box "}>
                  <div className="box__inner">
                    <div className="box__head">
                    ...
                    <div className="box__entry">
                      <p>
                        Want to get your social media marketing trending? See
                        your personal Instagram engagement skyrocket? Attract a
                        wider audience for your Insta page? Our Twicsy staff can
                        design a strategy that meets your goals – or you can
                        choose from our proven, pre-designed likes, view count,
                        and Instagram follower packages.
                      </p>
                    </div>
                    <div className="svg-image svg-image--boxPurpleBlob box__image">
                      <svg
                        width="168"
                        height="165"
                        viewBox="0 0 168 165"
                    ...
                    <button type="button" onClick={btnSign2} className={style2?"btn-more box__btn is-active " :"btn-more box__btn "}>
              ...
              <li>
                <div onClick={btnActive4} className={act3?"box is-expanded":"box "}>
                  <div className="box__inner">
                    <div className="box__head">
                      <strong>
                        Get Highest Quality, Instant Views, Likes, and Follows
                      </strong>
                    </div>
                    <div className="box__entry">
                      <p>
                        Many Instagram services use bots and fake accounts to
                        give you worthless follows, likes, or views, which
                        quickly disappear. That's just a scam. When you purchase
                        Instagram services from Twicsy, the likes, follows, and
                        views come from real Instagram users – real people. That
                        translates into Instagram growth and power!
                      </p>
                    </div>
                    <div className="svg-image svg-image--boxYellowBlob box__image">
                      <svg
                        width="183"
                        height="198"
                        viewBox="0 0 183 198"
                    ...
                    <button type="button" onClick={btnSign3} className={style3?"btn-more box__btn is-active " :"btn-more box__btn "}>
