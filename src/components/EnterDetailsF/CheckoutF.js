...
export default function CheckoutF(props) {
  var textstyle = {
    padding:"18px",
    color: "#0A7E7E"
  };
  ...
  <div className="checkflex ftop">
      ...
      <div className="box order-review open">
        ...
        <div className="body">
          <div className="r-mobi">
            ...
            <div className="price">
              <span className="total-cost-mini">${props.prizef}</span>
            </div>
            <div className="arrow">
          ...
          <div className="r-body">
            ...
            <div className="r-user">
              ...
              />
              <div className="info">
                <div className="name">@{props.usernamef}</div>
            ...
            <div className="r-plan">
              <div className="r-item">
                ...
                <div className="info">
                  ...
                  <div className="extra">
                    <strong>{props.followers}</strong> followers / <strong>1</strong> posts
                  </div>
                </div>
                <div className="price">${props.prizef}</div>
              </div>
              <div className="r-item upsell">
                ...
                <div className="info">
                  <span>
                    <strong>50</strong> followers per post
                  </span>{" "}
            ...
            <div className="r-upsell" data-id={1} data-cost="1.11">
              <div className="line">
                ...
                <div className="text">
                  Add <strong>50</strong> followers per post and{" "}
            ...
            <div className="r-total">
              ...
              <strong className="total-cost price">{"="} ${props.prizef}</strong>
            </div>
            ...
            <div className="r-feature">
              <div className="item ">
                ...
                <div className="text">
                  <strong>Real followers</strong> from real people
                </div>
              </div>
              <div className="item">
                <div className="icon">
                ...
                <div className="text">
                  <strong>Split followers</strong> on multiple posts
                </div>
              </div>
              <div className="item">
                <div className="icon">
      ...
      <div className="box ccheckout">
        ...
        <div className="body">
          ...
          <button onClick={(e)=>{e.preventDefault()
            ...
            Pay ${props.prizef} USD Using Paypal
            {/* <span className="">
              Pay 
            </span> */}
          </button>
    ...
    />}
          <button onClick={(e)=>{e.preventDefault()
            ...
            Pay ${props.prizef} USD Using Stripe
            {/* <span className="">
              Pay 
            </span> */}
          </button>
          {stripe2 && <StripeContainer prizef={props.prizef}/> }
              ...
              <div className="items">
                <div className="items-inner">
                  <div className="item">
                    ...
                    <div className="desc">{props.followers}</div>
                    <div className="price">
